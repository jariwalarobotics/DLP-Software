...
"}"));
        ...
        sizePolicy2.setHeightForWidth(groupBox_firmware->sizePolicy().hasHeightForWidth());
        groupBox_firmware->setSizePolicy(sizePolicy2);
...
";}"));
        ...
        sizePolicy4.setHeightForWidth(label_version->sizePolicy().hasHeightForWidth());
        label_version->setSizePolicy(sizePolicy4);
        QFont font1;
        ...
        sizePolicy4.setHeightForWidth(label_Tag->sizePolicy().hasHeightForWidth());
        label_Tag->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(apiVersionLabel->sizePolicy().hasHeightForWidth());
        apiVersionLabel->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(firmwareTag_label->sizePolicy().hasHeightForWidth());
        firmwareTag_label->setSizePolicy(sizePolicy4);
        ...
        sizePolicy2.setHeightForWidth(groupBox_ChipSetType->sizePolicy().hasHeightForWidth());
        groupBox_ChipSetType->setSizePolicy(sizePolicy2);
...
";}"));
        ...
        sizePolicy2.setHeightForWidth(operatingModes_groupBox->sizePolicy().hasHeightForWidth());
        operatingModes_groupBox->setSizePolicy(sizePolicy2);
...
";}"));
        ...
        sizePolicy2.setHeightForWidth(status_groupBox->sizePolicy().hasHeightForWidth());
        status_groupBox->setSizePolicy(sizePolicy2);
...
"border:1px solid black}"));
        ...
        sizePolicy5.setHeightForWidth(groupBox_PatternMode->sizePolicy().hasHeightForWidth());
        groupBox_PatternMode->setSizePolicy(sizePolicy5);
        QFont font2;
...
";}"));
        ...
        sizePolicy6.setHeightForWidth(ptnSetting_groupBox->sizePolicy().hasHeightForWidth());
        ptnSetting_groupBox->setSizePolicy(sizePolicy6);
...
"color:rgb(0,150,150);}"));
        ...
        sizePolicy7.setHeightForWidth(groupBox_Timing->sizePolicy().hasHeightForWidth());
        groupBox_Timing->setSizePolicy(sizePolicy7);
...
"border:1px solid black}"));
        ...
        groupBox_LEDDriver->setGeometry(QRect(9, 9, 1078, 621));
        sizePolicy5.setHeightForWidth(groupBox_LEDDriver->sizePolicy().hasHeightForWidth());
        groupBox_LEDDriver->setSizePolicy(sizePolicy5);
...
";}"));
        ...
        sizePolicy8.setHeightForWidth(USBDevicePath_TextEdit->sizePolicy().hasHeightForWidth());
        USBDevicePath_TextEdit->setSizePolicy(sizePolicy8);
        QFont font6;
...
";}"));
        ...
        label_ReadBuffer->setFont(font7);
        ...
        font8.setBold(true);
        font8.setWeight(75);
        pushButton_RestartLEDDriver->setFont(font8);
...
";}"));
        ...
        checkBox_InternalInitialization->setFont(font9);
        ...
        checkBox_LEDTempOK->setFont(font9);
        ...
        checkBox_DMDTempOK->setFont(font9);
        ...
        checkBox_BoardTempOK->setFont(font9);
        ...
        checkBox_HardwareOK->setFont(font9);
        ...
        checkBox_IntensityCalOK->setFont(font9);
        ...
        checkBox_WriteProtection->setFont(font9);
        ...
        checkBox_IntensityModInstall->setFont(font9);
        ...
        label_DMDTempMax->setFont(font9);
...
";}"));
        ...
        label_LEDTempMax->setFont(font9);
...
";}"));
        ...
        label_BoardTempMax->setFont(font9);
...
";}"));
        ...
        label_LEDCurrentMax->setFont(font9);
...
";}"));
        ...
        label_IntensityVoltage->setFont(font7);
...
";}"));
        ...
        PCBFanSpeed_text->setFont(font9);
...
";}"));
        ...
        DMDFanSpeed_text->setFont(font9);
...
";}"));
        ...
        LEDFanSpeed_text->setFont(font9);
...
";}"));
        ...
        pushButton_LEDPWMON_OFF->setFont(font8);
        ...
        label_Intensity2->setFont(font7);
        ...
        pushButton_ExTrigger->setFont(font8);
        ...
        pushButton_SwTrigger->setFont(font8);
        ...
        sizePolicy8.setHeightForWidth(Text_Readbuffer->sizePolicy().hasHeightForWidth());
        Text_Readbuffer->setSizePolicy(sizePolicy8);
        Text_Readbuffer->setFont(font9);
...
";}"));
        ...
        LEDCurrent_lineEdit->setFont(font9);
        ...
        Intensity_lineEdit->setFont(font9);
        ...
        label_LEDDriverStatus->setFont(font7);
...
""));
        ...
        ManualGcode_GroupBox->setFont(font11);
...
";}"));
        ...
        ClearManualGcode->setFont(font8);
...
";}"));
        ...
        sizePolicy9.setHeightForWidth(ComPort->sizePolicy().hasHeightForWidth());
        ComPort->setSizePolicy(sizePolicy9);
        ComPort->setMinimumSize(QSize(0, 30));
        ComPort->setFont(font7);
